...
!!   - [-out filename_out]: Name of output file containing scaled sky.
!!   - [-mult mult_factor]: Scale factor to multiply map by.
...
program s2_skymultiply
  ...
  ! Scale the map.
  call s2_sky_scale(sky, mult_factor)
    ...
    subroutine parse_options()
      ...
      do i = 1,n,2
        ...
        select case (trim(opt))
          ...
          case ('-help')
            write(*,'(a)') 'Usage: s2_skymultiply [-inp filename_in]'
            write(*,'(a)') '                       [-out filename_out]'
            write(*,'(a)') '                       [-mult mult_factor]'
